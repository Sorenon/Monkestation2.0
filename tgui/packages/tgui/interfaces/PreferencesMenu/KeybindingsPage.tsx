      ...
      return (
        <Stack.Item key={keybindingId} mb={1}>
          <Stack fill>
            ...
            {range(0, 3).map((key) => (
              <Stack.Item key={key} grow basis="10%" maxWidth="75px">
                <KeybindingButton
...
export class KeybindingsPage extends Component<any, KeybindingsPageState> {
  ...
  render() {
    ...
    Object.values(keybindings).forEach((category) => {
      Object.entries(category).forEach(([keybindingId, keybinding]) => {
